    ...
    return (
        <div className={styles.container}>
            ...
            <header className="text-center mb-8">
                <h1 className="text-3xl font-bold mb-2">Thumbnail Taker</h1>
            ...
            <section className="how-to-section">
                <h3 className="text-gray-700">To acquire a YouTube thumbnail, follow these steps:</h3>
                ...
                <main className={styles.main}>
                    ...
                    <div className={styles.grid}>
                        <div className={styles.card}>
                            <section className="how-to-section">
                                <h3 className="text-gray-700">What YouTube Thumbnail Quality You Will Get?</h3>
                                <p className="text-gray-700">
                                ...
                                <h3 className="text-gray-700">What is the Use of This YouTube Thumbnail Grabber Website?</h3>
                                <p className="text-gray-700">
                                ...
                                <h3 className="text-gray-700">Is It Legal to Download YouTube Thumbnails?</h3>
                                <p className="text-gray-700">
                                ...
                                <h3 className="text-gray-700">Is The YouTube Thumbnail Downloader Free or Paid?</h3>
                                <p className="text-gray-700">
                                ...
                                <h3 className="text-gray-700">Is There Any Copyright Risk on YouTube Thumbnails?</h3>
                                <p className="text-gray-700">
                                ...
                                <h3 className="text-gray-700">Conclusion</h3>
                                <p className="text-gray-700">
